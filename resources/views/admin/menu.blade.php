    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview @if($name == 'admin.product.create' || $name == 'admin.product.categories') menu-open @endif">
                    <a href="#" class="nav-link @if($name == 'admin.product.create' || $name == 'admin.product.categories') active @endif">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('admin.product.create')}}" class="nav-link @if($name == 'admin.product.create') active @endif">
                                <i class="fa fa-plus-circle nav-icon"></i>
                                <p>Add Product</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('admin.product.categories')}}" class="nav-link @if($name == 'admin.product.categories') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('logout') }}" class="nav-link" onclick="event.preventDefault();  document.getElementById('dashboard-logout-form').submit();">
                        <i class="nav-icon fas fa-th"></i>
                        <p>
                            {{ __('Logout') }}
                        </p>
